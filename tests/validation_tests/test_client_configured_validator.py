...
def test_get_kwargs_for_filevalidator_defaults_to_none_on_valueerror():
    # To be added
    pass
...
def test_get_kwargs_for_filevalidator_raises_exception_when_validator_method_not_found():
    ...
    with pytest.raises(ValueError) as exception_info:
        get_kwargs_for_filevalidator(VeryBadClass)
    assert ".VeryBadClass'> does not have a 'validate' method" in str(exception_info.value)
