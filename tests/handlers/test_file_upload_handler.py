...
@pytest.mark.parametrize(
    "request_type, file_existed, expected_status_code, expected_success_message",
    [
        (RequestType.PUT, False, 201, "File saved successfully in test_bucket with key test_file.txt"),
        (RequestType.PUT, True, 200, "File saved successfully in test_bucket with key test_file.txt"),
        (RequestType.POST, False, 201, "File saved successfully in test_bucket with key test_file.txt"),
        (
            RequestType.POST,
            True,
            409,
...
async def test_handle_file_upload(
    ...
    if request_type == RequestType.POST and file_existed:
